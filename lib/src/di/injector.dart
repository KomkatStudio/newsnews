...
import 'package:newsnews/src/data/datasources/firebase_auth_datasource_impl.dart';
...
void initDependence() {
  ...
  ///DataSource
  s1.registerLazySingleton<NewsApiRemoteDatasouce>(() => NewsApiRemoteDatasouce(s1()));
  ...
  s1.registerFactory<AuthCubit>(() => AuthCubit(
      signInWithGoogle: s1(), hasCurrentUser: s1(), getCurrentUser: s1()));
}
